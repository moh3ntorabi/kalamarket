...
namespace WebSite.EndPoint.Models
{
    public class MenuItemTagHelper:TagHelper
    {
        ...
        private TagBuilder GetContent()
        {
            ...
            TagBuilder liMain1 = null;
            TagBuilder liMain2 = new TagBuilder("br");
            foreach (var item in data.Where(p => p.ParentId == null))
            {

               
                liMain1 = CreateLi(item.Name, "");
                ...
                liMain1.InnerHtml.AppendHtml(ul);
                liMain2.InnerHtml.AppendHtml(liMain1);
