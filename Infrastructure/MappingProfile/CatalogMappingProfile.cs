    ...
    public class CatalogMappingProfile:Profile
    {
        public CatalogMappingProfile()
        {
            ...
            CreateMap<CatalogType, CatalogTypeListDto>()
                .ForMember(dest => dest.SubTypeCount, opt =>
                   opt.MapFrom(src => src.SubType.Count)).ReverseMap();
            ...
            CreateMap<CatalogType, MenuItemDto>()
                 ...
                 opt.MapFrom(src => src.SubType)).ReverseMap();
            //----------------------
            ...
            CreateMap<CatalogBrand, BrandDto>().ReverseMap();
